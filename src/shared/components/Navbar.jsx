  ...
  return (
    <>
      <nav className="absolute top-4 sm:top-6 left-1/2 transform -translate-x-1/2 w-[95%] sm:w-[98%] max-w-[1400px] xl:bg-white/95 xl:backdrop-blur-xl border-transparent xl:border xl:border-white/60 rounded-full xl:shadow-soft flex items-center justify-between px-4 sm:px-6 py-2.5 sm:py-3 z-[60] transition-all duration-500">
        ...
        {/* LEFT: Logo Section (Restored to Typography) */}
        <Link
          to="/"
          onClick={closeMenu}
          className="flex items-center gap-2 cursor-pointer group shrink-0"
        >
          {/*<span className="font-serif font-bold text-[16px] sm:text-[20px] text-brand-navy whitespace-nowrap tracking-tight drop-shadow-sm xl:drop-shadow-none">
            Blue Sparrow <span className="text-[#4f46e5] text-[9px] sm:text-[11px] uppercase tracking-[0.2em] ml-1">Events</span>
          </span>*/}
        </Link>

        {/* CENTER: Desktop Navigation Links */}
        <div className="hidden xl:flex items-center gap-3 2xl:gap-5">
          <Link to="/" className="text-brand-navy font-medium text-[12px] 2xl:text-[13px] hover:text-[#4f46e5] transition-colors duration-300">Home</Link>
          <Link to="/about" className="text-gray-600 font-medium text-[12px] 2xl:text-[13px] hover:text-[#4f46e5] transition-colors duration-300">About Us</Link>
          <Link to="/kids-parties" className="text-gray-600 font-medium text-[12px] 2xl:text-[13px] hover:text-[#4f46e5] transition-colors duration-300">Birthday Party</Link>
          <Link to="/corporate" className="text-gray-600 font-medium text-[12px] 2xl:text-[13px] hover:text-[#4f46e5] transition-colors duration-300">Corporate Family Days</Link>
          <Link to="/carnivals" className="text-gray-600 font-medium text-[12px] 2xl:text-[13px] hover:text-[#4f46e5] transition-colors duration-300">Carnival</Link>
          <Link to="/family-day" className="text-gray-600 font-medium text-[12px] 2xl:text-[13px] hover:text-[#4f46e5] transition-colors duration-300">Family Day</Link>
          <Link to="/malls" className="text-gray-600 font-medium text-[12px] 2xl:text-[13px] hover:text-[#4f46e5] transition-colors duration-300">Malls & Brands</Link>
          
          {/* THEMES DROPDOWN */}
          <div className="relative group">
            <span className="text-gray-600 font-medium text-[12px] 2xl:text-[13px] hover:text-[#4f46e5] transition-colors duration-300 flex items-center gap-1 cursor-pointer py-2">
        ...
        <div className="flex items-center gap-3 shrink-0 relative">
          <Link to="/contact" className="hidden xl:flex bg-[#4f46e5] hover:bg-[#4338ca] text-white text-[12px] 2xl:text-[13px] font-bold py-2.5 px-6 rounded-full shadow-soft hover:shadow-md transform hover:-translate-y-0.5 transition-all duration-300">
            Enquire Now
          </Link>
          
          {/* Small Circle Menu Button */}
          <button 
